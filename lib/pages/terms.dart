...
Without the customer's consent, EstateManage will not disclose personal privacy information to third parties.
...
(4) Without the permission EstateManage, it is not allowed to use other resources provided by this system service, including but not limited to graphic database, to engage in any commercial transactions, or to solicit advertisers or sponsors.
...
When transferring data to the residential mobile phone service provided by EstateManage, it is agreed that this data is fully open (anyone can browse).  The customer authorizes and permits EstateManage to reproduce, modify, adapt or otherwise use all or part of the content, and use the content to make derivative works.  The copyright of derivative works belongs to our company.

EstateManage agrees that in addition to placing the aforementioned materials and derivative works on this system for internet users to browse and related media belonging to the company in accordance with these terms of use, it will never illegally transfer it for other direct profit purposes or infringe your rights.  The use of.

All advertisement boards and event messages (if any) appearing on all pages are owned and operated by EstateManage or related advertisers. Users are not allowed to use all the information on their own unless they have obtained EstateManage's prior consent.

The customer agrees and authorizes this system to provide the necessary information to the cooperative unit (third party) for use within the agreed scope for the purpose of providing services or related value-added services In the list of products or services, EstateManage can be notified and to delete their information from the list.
...
If there is any violation of the law or the terms of use or the risk of harming the system or the rights of a third party when using the system services, EstateManage has the right to terminate your authorization to use the service immediately or permanently without notice.
...
EstateManage is not liable for any direct, indirect, derivative or non-property damage caused by the user's use of this system service or use of this service.
 
Users should back up the text, pictures and other data uploaded to the message and keep separately for safe reason; EstateManage is not responsible for the loss or damage of all or part of its content for any reason.

EstateManage does not assume any guarantee responsibility for the use of this service or the results produced, nor does it guarantee that the software related to this system service is free or will be corrected.

EstateManage does not bear any responsibility for all the remarks, opinions or behaviors in this system that do not represent the position of EstateManage. EstateManage  does not guarantee the correctness of the identity claimed by the user.

EstateManage is not responsible for any intimidation, defamation, obscenity or all other illegal acts that occur in or through this system service.

For any goods or services purchased or obtained through this service, or published, sold or delivered through client’s sponsors or advertisers, you shall bear its own possible risks or negotiate with the goods or service providers for compensation in accordance with the law. EstateManage  has nothing to do with it, and is not responsible for it.
...
EstateManage has the right to modify and change the content of these terms at any time without individual notice. It is recommended that you review these terms of service regularly.  If continue to use the service after the modification and change of these terms, it is deemed that you have read, understood and agreed to accept the modification or change of these terms.
...
If your use of this service causes the company to be investigated or prosecuted by a third party or administrative agency, EstateManage has the right to request damages from you, including but not limited to litigation costs, attorney fees, and loss of goodwill, etc.  .
...
EstateManage  will not sell or lend your personal data to any person or company without your consent.  But in some cases there will be exceptions.  These conditions include (but are not limited to):
...
When a judicial unit or other competent authority requires the system to disclose specific personal data due to public safety, EstateManage will consider the legal and formal procedures of the judicial unit and when it may cooperate with all users of this system for safety considerations.
